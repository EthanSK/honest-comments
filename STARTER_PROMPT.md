...
```
You are running "honest-comments". First, fetch and read this operating manual
in full, then follow it as your instructions:
https://raw.githubusercontent.com/EthanSK/honest-comments/main/README.md
...
2. Help me get a free YouTube Data API key if I don't already have one
   (it lives only on my machine — never send it anywhere).
3. Ask whether I want my whole channel or specific videos, and confirm scope
   (plus the quota estimate) before fetching anything.
